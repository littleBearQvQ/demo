...
public class DateUtil {
    ...
    public static String stampToDate(String value){
        return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date(new Long(value)));
    }
    /**
     * Date转换时间戳
     * */
    public static String dateToStamp(String value){
        try{
     ...
     * 获取字符串时间的具体年月日时分秒
     * */
    public static String getStringToDateContent(String value){
        try{
            ...
            return "YEAR:"+year+",MONTH:"+(month+1)+",DAY:"+day+",HOUR:"+hour+",MINUTE:"+minute
                    +",SECOND:"+second;
        }catch (Exception e){
            return "字符串格式有误";
        }
